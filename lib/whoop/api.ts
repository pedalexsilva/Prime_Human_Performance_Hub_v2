...
/* -----------------------------------------
   FETCH ALL DATA
   ⚠️ ATUALIZADO: Com recovery, profile e body measurements
----------------------------------------- */
export async function fetchAllData(
  ...
  try {
    // Fetch time-based metrics in parallel
    ...
    // Fetch profile data (not time-based) - these may fail if not authorized
    let profile = null
